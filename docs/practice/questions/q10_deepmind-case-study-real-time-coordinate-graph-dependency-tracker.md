...
Treat this as a user-space data-structure problem for repeated transform queries. Precompute what is stable, store compact indices instead of pointer-heavy graph objects, and make the hot path allocation-free.
